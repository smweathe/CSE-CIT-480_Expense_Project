  ...
  <noscript><iframe height="0" src="//www.googletagmanager.com/ns.html?id=GTM-JD26" style="display:none;visibility:hidden" width="0"></iframe></noscript>
    ...
    <div class="benefits page-body" style="padding: 30px;">
          <form action="#" class="gtm_expense_form" id="expenseform" method="post">
            ...
            <h3><center>Distance Form</center></h3>
            <center><i class="fa fa-plane fa-5x" aria-hidden="true"></i></center>
            <br>
            Distance($0.54 per mile): <input type="number" class="required" name="distance" placeholder="miles" tabindex="1" min="0" max="9999999.99" step"1" style="margin-bottom: 5px"><sup class="required" title="Required"></sup>
            ...
            Upload Receipt: <input type="file" name="expense_receipt" tabindex="5" style="margin-bottom: 5px"><br><br>
